<template>
  <Page>
    <header id="genturis-privacy">
      <h1>GENTURIS registry privacy policy</h1>
    </header>
    <Section
      id="genturis-privacy-google"
      aria-labelledby="genturis-privacy-google-title"
    >
      <h2 id="genturis-privacy-google-title">
        Google analytics
      </h2>
      ...
      <p>Google will use this information for the purpose of evaluating your use of the website, compiling reports on website activity for the ERN GENTURIS project management team, and providing other services to the ERN GENTURIS project management team relating to website activity and internet usage. Google will not associate your IP address with any other data held by Google.</p>
      <p>You may refuse the use of cookies by selecting the appropriate settings on your browser, however please note that if you do this you may not be able to use the full functionality of this website. By using this website, you consent to the processing of data about you by Google in the manner and for the purposes set out above.</p>
      <p>You can prevent Google’s collection and use of data (cookies and IP address) by downloading and installing the browser plug-in available under <a href="https://tools.google.com/dlpage/gaoptout?hl=en">https://tools.google.com/dlpage/gaoptout?hl=en</a>.</p>
    </Section>
    <Section
      id="genturis-privacy-eservices"
      aria-labelledby="genturis-privacy-eservices-title"
    >
      <h2 id="genturis-privacy-eservices-title">
        E-Services
      </h2>
      <p>When you contact us by e-mail, your personal data is collected only to the extent necessary to reply. If the team responsible for the mailbox is unable to answer your question, or your questions has regards to another party, it might forward your email to another service.</p>
      ...
      <p>Our server, where all information is held, is located in The Netherlands meaning all the data and information we store is held within the EU.</p>
    </Section>
    <Section
    ...
    >
      ...
      <p>The collected personal data and all information related to the above mentioned consultation is stored on the e-mail server of the ERN GENTURIS Coordinating office at Radboudumc and potentially those who have been concerned in the correspondence in order to respond to your comment.</p>
    ...
    >
      <h2 id="genturis-privacy-contact-title">
        Contact
      </h2>
    ...
    >
      <h2 id="genturis-privacy-links-title">
        Third Party Links
      </h2>
